<?php
    ...
    require_once("guest_side/serviceCategory_modal.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="guest_side/css/guest-style.css">
    <title>Home</title>
</head>
<body>
    <!------------------ NAVBAR LINK and LOGOUT MODAL----------------->
    <?php 
        include("guest_side/guest_navbar.php");
        include("guest_side/logout_modal.php");
    ?>
    ...
    <div class="main">
        <div class="service-content">
            ...
            <div class="service-buttons">
                <a href="javascript:void(0);" class="btn-services" onclick="show_reserve_modal()">Reserve Now</a>
                <a class="btn-services" type="button" href="guest_side/appointment.php">Make an appointment</a>
            </div>
        </div>
    </div>
    ...
    <div class="content-below">
        ...
        <center><a class="btn-services" type="button" href="guest_side/photos.html">See Photos ></a></center>
    </div>
    ...
    <!------------------ FOOTER LINKS  ------------->
    <?php include("guest_side/guest_footer.php");?>
    ...
    <script src="guest_side/js/data_visualization.js"></script>


    <!----------- PHOTO GALLERY SCRIPT LINK -------------->
    <script src="guest_side/js/photo_gallery.js"></script>


    <!----------- MESSAGE NOTIFICATION ------------->
    <script src="guest_side/js/notification.js"></script>
