...
$sqlCount2 = "SELECT COUNT(*) AS retreat FROM (
                ...
                UNION ALL
                SELECT * FROM training_reservation_record
            ) AS all_reservations WHERE type = 'retreat'";
...
$sqlCount3 = "SELECT COUNT(*) AS reception FROM (
                ...
                UNION ALL
                SELECT * FROM training_reservation_record
            ) AS all_reservations WHERE type = 'reception'";
...
$sqlCount4 = "SELECT COUNT(*) AS recollection FROM (
                ...
                UNION ALL
                SELECT * FROM training_reservation_record
            ) AS all_reservations WHERE type = 'recollection'";
...
$sqlCount5 = "SELECT COUNT(*) AS training FROM (
                ...
                UNION ALL
                SELECT * FROM training_reservation_record
            ) AS all_reservations WHERE type = 'training'";
...
$sqlCount6 = "SELECT COUNT(*) AS seminar FROM (
                ...
                UNION ALL
                SELECT * FROM training_reservation_record
            ) AS all_reservations WHERE type = 'seminar'";
...
$pdf->Cell(1, 5, '', 0, 1);
$pdf->Cell(120, 5, '', 0, 0);
$pdf->Cell(100, 5, 'Reservation Report', 0, 1); //end of line
...
$pdf->Cell(1, 5, '', 0, 1);
$pdf->Cell(20, 5, '', 0, 0);
$pdf->Cell(100, 5, 'Total Retreat Reservations: ' . $retreat . '', 0, 1); //end of line
$pdf->Cell(1, 5, '', 0, 1);
$pdf->Cell(20, 5, '', 0, 0);
$pdf->Cell(100, 5, 'Total Reception Reservations: ' . $reception . '', 0, 1); //end of line
$pdf->Cell(1, 5, '', 0, 1);
$pdf->Cell(20, 5, '', 0, 0);
$pdf->Cell(100, 5, 'Total Recollection Reservation: ' . $recollection . '', 0, 1); //end of line
$pdf->Cell(1, 5, '', 0, 1);
$pdf->Cell(20, 5, '', 0, 0);
$pdf->Cell(100, 5, 'Total Training Reservations: ' . $training . '', 0, 1); //end of line
$pdf->Cell(1, 5, '', 0, 1);
$pdf->Cell(20, 5, '', 0, 0);
$pdf->Cell(100, 5, 'Total Seminar Reservation: ' . $seminar . '', 0, 1); //end of line
$pdf->Cell(1, 5, '', 0, 1);
$pdf->Cell(20, 5, '', 0, 0);
