...
$sqlCount6 = "SELECT COUNT(*) AS total FROM (
   ...
   $row = $result6->fetch_object();
    ...
    $sqlCount7 = "SELECT MAX(type) AS max FROM (
                SELECT * FROM reception_reservation_record
                UNION ALL
                SELECT * FROM recollection_reservation_record
                UNION ALL
   ...
   $row = $result7->fetch_object();
    $max = $row->max;

    $sqlCount8 = "SELECT MIN(type) AS min FROM (
                SELECT * FROM reception_reservation_record
                UNION ALL
                SELECT * FROM recollection_reservation_record
                UNION ALL
...
$pdf->Cell(1 ,5,'',0,1);
$pdf->Cell(20 ,5,'',0,0);
$pdf->Cell(100 ,5,'Most Reserved Service: '.$max.'',0,1);//end of line
$pdf->Cell(1 ,5,'',0,1);
$pdf->Cell(20 ,5,'',0,0);
$pdf->Cell(100 ,5,'Least Reserved Service: '.$min.'',0,1);//end of line
$pdf->Cell(1 ,5,'',0,1);
$pdf->Cell(20 ,5,'',0,0);
