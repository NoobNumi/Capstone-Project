...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE $table SET dessert ='$dessert' WHERE transaction_num = '$transact'";
  $conn->query($sql) or die($conn->error);

  header('Location: select_meal5.php?transact='.$transact.'&type='.$type);
...
<body>
 ...
 <div class="row">
    ...
    <div class="col-md-9">  
         ...
         <p class="reservation-title">Select Dessert</p>
         <?php $sql = "SELECT *  FROM meals WHERE type = 'dessert'";
      ...
      <div class="container col-md-4 mt-3 mb-5">
        ...
        <div class="card">
            ...
            <div class=" mx-3 my-3" align="right">
             <input type="hidden" name="dessert" value="<?php echo $row['meal_name']; ?>">
