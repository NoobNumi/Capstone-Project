...
<body style="overflow-x: hidden;">
    ...
    <section class="training-reserve reserve">
        <div class="res-header">
            <h4 class="reservation-name">Training</h4>
                    ...
                    <div class="card-package">
                        ...
                        <div class="right-side-package">
                            ...
                            <div class="ammenity-info">
                                <?php
                                    $trainingPackage = getPackageDetails('Training Package');
                                    if ($trainingPackage) {
                                        echo '<p class="price">₱' . number_format($trainingPackage['price'], 2) . ' Per Venue</p>';
                                        echo '<p class="package-description">' . $trainingPackage['description'] . '</p>';
                                    }
                                ?>
                            </div>
                            <div class="desktop-view-button">
                                <a href="#" class="button-view-details" id="openTrainingButton">View Package Details</a>
                            </div>
